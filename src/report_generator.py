...
class ReportGenerator:
    ...
    def _js_render(self):
        ...
        return (
            ...
            "try{return new Date(g.commence_time).getTime()>now;}catch(e){return true;}});"
            "var h='';"
            # \u2500\u2500 Moneyline / -1.5 : tableau equipe / prob / cote / value / bet \u2500\u2500
            ...
            "mlrows.push({g:g,b:b});});});"
            "if(mlrows.length){"
            "h+='<div class=\"mlb-header\">MLB Moneyline / -1.5 \u2014 probabilit\u00e9 \u00d7 cote</div>';"
            "h+='<div class=\"ml-tbl\">';"
            ...
            "var b=r.b;var v=(b.valeur_pct==null?null:b.valeur_pct);"
            "var vc=v==null?'var(--m)':(v>=8?'#0F6E56':v>=3?'#2563EB':v>=0?'#BA7517':'#DC2626');"
            "var mk=b.marche==='moneyline'?'ML':'-1.5';"
            "h+='<div class=\"ml-tr\" title=\"'+(b.raison||'').replace(/\"/g,'')+'\">';"
            ...
            "calibration \u2014 volontairement r\u00e9tr\u00e9ci vers le march\u00e9).</div>';"
            "}"
